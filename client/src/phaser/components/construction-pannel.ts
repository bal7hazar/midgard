...
export default class ConstructionPannel extends Phaser.GameObjects.Container {
  ...
  constructor(scene: Phaser.Scene, x: number, y: number, handleClose: () => void) {
    ...
    this.buildingBanner = new Phaser.GameObjects.Image(scene, 0, -168, "banner-v-up-w7-h5");
    this.builderBanner = new Phaser.GameObjects.Image(scene, 0, 164, "banner-v-down-w7-h5");
    this.buildingCarved = new Phaser.GameObjects.Image(scene, 0, -200, "carved-w5-h2");
    this.builderCarved = new Phaser.GameObjects.Image(scene, -96, 196, "carved-w2-h2");
    this.buttonCarved = new Phaser.GameObjects.Image(scene, 64, 196, "carved-w3-h1");
    this.buildingRibbon = new Phaser.GameObjects.Image(scene, 0, -104, "ribbon-w5-h1-yellow");
    this.builderRibbon = new Phaser.GameObjects.Image(scene, 0, 100, "ribbon-w5-h1-yellow");

    // Commands
    this.close = new Command(scene, 196, -224, "icon-close", "icon-close-pressed", { onRelease: handleClose });

    // Create label
    this.buildingLabel = new Phaser.GameObjects.Text(scene, 0, -112, 'Building', {
      fontFamily: "Norse",
      fontSize: 32,
      color: "#ffffff",
      stroke: "#000000",
    ...
    // Add sprites
    this.building = new Phaser.GameObjects.Image(scene, 0, -232, "building-house-blue");
    this.builder = scene.add.sprite(-96, 164, "pawn-blue");
    this.builder.setScale(1.5);
    this.builder.play("pawn-blue-idle");
    ...
    this.gold = new Resource(scene, 160, -104, "ribbon-w4-h1-red", "0", "icon-gold");
    this.score = new Resource(scene, 160, -168, "ribbon-w4-h1-red", "0", "icon-score");
    this.cost = new Resource(scene, -160, 164, "ribbon-w4-h1-red", "0", "icon-gold");
    this.cost.flipX();
